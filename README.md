...
وێنەی ئامادەکراو بۆ ٥ وەرزش لە `assets/sports/`دان (تۆپی پێ، فوتسال، تۆپی باڵە، تۆپی سەبەتە، تۆپی دەست). هەر وێنە یان ڤیدیۆیەک لە پانێڵەکەوە بۆ هەمان وەرزش دابنێیت، جێگەی دەگرێتەوە.
