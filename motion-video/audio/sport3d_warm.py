#!/usr/bin/env python3
"""Warm alternative music for sport3d.html: a light 96 bpm piece in C major.

(audio/sport3d.py holds the main score, a cinematic one made from recorded
instruments. This synthesised version is the brighter alternative.)
...
if __name__ == '__main__':
    main(sys.argv[1] if len(sys.argv) > 1 else 'audio/sport3d-cues.json',
         sys.argv[2] if len(sys.argv) > 2 else 'output/sport3d-warm-sfx.wav')
