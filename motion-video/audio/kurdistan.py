...
The progression is Am F C G twice, then Dm F G C. The writing is restrained:
a lyrical piano melody over quiet broken chords, long strings, and horns only
for the last bars. Every scene change and text reveal gets a soft air
whoosh, and the balls get small sounds of their own.
...
HORN = [(9, 0, 'F3', 4), (9, 0, 'A3', 4), (10, 0, 'F3', 4), (10, 0, 'C4', 4), (11, 0, 'G3', 4), (11, 0, 'D4', 4),
        (12, 0, 'E3', 4), (12, 0, 'G3', 4), (12, 0, 'C4', 4)]
# the piano melody: (bar, beat, note, beats)
MELODY = [(3, 0, 'E5', 2), (3, 2, 'G5', 1), (3, 3, 'E5', 1), (4, 0, 'D5', 3), (4, 3, 'B4', 1),
          (5, 0, 'C5', 2), (5, 2, 'E5', 1), (5, 3, 'A5', 1), (6, 0, 'A5', 2), (6, 2, 'G5', 1), (6, 3, 'F5', 1),
          (7, 0, 'E5', 3), (7, 3, 'G5', 1), (8, 0, 'D5', 2), (8, 2, 'B4', 2), (9, 0, 'F5', 2), (9, 2, 'A5', 1),
          (9, 3, 'F5', 1), (10, 0, 'E5', 2), (10, 2, 'C5', 2), (11, 0, 'D5', 2), (11, 2, 'G5', 2)]
...
def main(cue_path, out_path):
    ...
    put('piano', piano[5].play('G5', dur=1.0, release=1.2), bar_t(12, 2), 0.3, 0.25)
    put('piano', piano[5].play('C6', dur=1.0, release=1.3), bar_t(12, 3), 0.28, 0.3)
    ...
    for at, size, g in [(bar_t(5), 0.8, 0.25), (bar_t(9), 0.9, 0.3), (cues['wipe'], 1.3, 0.6), (bar_t(12), 1.0, 0.3)]:
    ...
    put('fx', thud(130), cues['ballRest'], 0.2, -0.2)
